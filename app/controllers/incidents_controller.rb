class IncidentsController < ApplicationController
  ...
  private
    ...
    def incident_params
      params.require(:incident).permit(:description, :datetime_of_incident, :location, :police_report_number, :video, :severity, car_attributes: [:id, :description, :make, :color, :license_plate, :damage, :driver_name, :driver_contact])
    end
end
